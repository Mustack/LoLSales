...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Skin'
        db.create_table('champions_skin', (
            ('product_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['champions.Product'], unique=True, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('champion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['champions.Champion'])),
        ))
        db.send_create_signal('champions', ['Skin'])


    def backwards(self, orm):
        # Deleting model 'Skin'
        db.delete_table('champions_skin')
