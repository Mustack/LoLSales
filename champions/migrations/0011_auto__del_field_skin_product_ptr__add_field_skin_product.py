...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Skin.product'
        #db.alter_column('champions_skin', 'product_ptr_id',
        #              self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['champions.Product'], unique=True, primary_key=True, db_column='product_ptr_id'),
        #              keep_default=False)
        pass
