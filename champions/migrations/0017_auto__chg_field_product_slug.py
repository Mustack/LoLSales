...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('champions_product', 'slug', self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=50))

    def backwards(self, orm):

        # Changing field 'Product.slug'
        db.alter_column('champions_product', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50, null=True))

    models = {
        'accounts.subscription': {
            'Meta': {'unique_together': "(('user', 'product'),)", 'object_name': 'Subscription'},
        ...
        'champions.skin': {
            ...
            'champion': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'skins'", 'to': "orm['champions.Champion']"}),
