...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.determiner'
        db.add_column('champions_product', 'determiner',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.determiner'
        db.delete_column('champions_product', 'determiner')
