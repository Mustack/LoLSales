...
from champions.models import _slugify_name
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for p in orm['champions.Product'].objects.all():
            _slugify_name(orm['champions.Product'], p, False, None)
            p.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        for p in orm['champions.Product'].objects.all():
            # Pretty sure this is pointless since the signal is still there
            p.slug = None
            p.save()
