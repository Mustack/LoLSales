...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Subscription', fields ['product', 'user']
        db.create_unique('accounts_subscription', ['product_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Subscription', fields ['product', 'user']
        db.delete_unique('accounts_subscription', ['product_id', 'user_id'])
