...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_subscription', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['champions.Product']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subscription.product'
        db.delete_column('accounts_subscription', 'product_id')
