...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_subscription', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subcriptions', to=orm['auth.User'])),
            ('champions', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['champions.Champion'])),
        ))
