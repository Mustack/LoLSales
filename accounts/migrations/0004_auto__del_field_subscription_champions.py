...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Subscription.champions'
        db.delete_column('accounts_subscription', 'champions_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Subscription.champions'
        raise RuntimeError("Cannot reverse this migration. 'Subscription.champions' and its values cannot be restored.")
